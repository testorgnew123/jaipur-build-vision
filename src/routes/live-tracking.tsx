...
export const Route = createFileRoute("/live-tracking")({
  head: () => ({
    meta: [
      { title: "Live Project Tracking Dashboard - Single Stop Building Solutions Pvt Ltd Jaipur" },
...
const features = [
  ...
  { icon: ClipboardCheck, title: "Milestone Records", desc: "Track completed work, pending tasks, and site notes in one place." },
  { icon: FileText, title: "Document Vault", desc: "Contracts, drawings, NOCs, and reports securely stored." },
    ...
    <>
      <section className="pt-32 pb-12 lg:pt-40 bg-muted/40">
        <div className="container-px mx-auto max-w-7xl text-center">
          <p className="text-xs font-semibold tracking-[0.2em] uppercase text-gold">Single Stop App</p>
